  ...
  return (
    ...
    <div className="w-screen h-[80vh] relative flex justify-start items-center">
       ...
       <div className="relative max-w-[80%] lg:max-w-[50%] text-left left-[10%] z-10">
         ...
         <button className="btn text-[#FFF] text-[15px] font-nunito-sans bg-[#385777] hover:bg-[#385790] font-medium uppercase rounded-full h-[50px] md:h-[60px] w-[160px] md:w-[190px] mt-4 md:mt-6">READ MORE</button>
       </div>
